...
public class HomeWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME))); //they're same
        ...
        Intent toastIntent = new Intent(context, HomeWidget.class);

        toastIntent.setAction(HomeWidget.TOAST_ACTION);
